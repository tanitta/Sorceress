	...
	namespace"model"{
		namespace"sorceress"{
			class "Wing"{
				...
				method"Z"
				:body(function(self)
					local geneAngle = self.gene:GetAngleValue(math.abs(self.sensors.core.lvz))

					self.val.fl=180-(4+geneAngle)*(1+self.inputs.perHandle*0.2)*(1-self.modes.flight)*(1-self.inputs.normalBrake)  - 67.5 *self.inputs.normalBrake- 0 *self.inputs.sideBrake
					self.val.fr=180-(4+geneAngle)*(1-self.inputs.perHandle*0.2)*(1-self.modes.flight)*(1-self.inputs.normalBrake)   - 67.5 *self.inputs.normalBrake- 0*self.inputs.sideBrake
					self.val.rl=0-(geneAngle)*(1+self.inputs.perHandle*0.2)*(1-self.modes.flight)*(1-self.inputs.normalBrake)  - 67.5 *self.inputs.normalBrake- 0 *self.inputs.sideBrake
					self.val.rr=0-(geneAngle)*(1-self.inputs.perHandle*0.2)*(1-self.modes.flight)*(1-self.inputs.normalBrake)  - 67.5 *self.inputs.normalBrake- 0 *self.inputs.sideBrake
